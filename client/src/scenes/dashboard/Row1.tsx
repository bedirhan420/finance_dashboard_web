...
import {ResponsiveContainer,AreaChart,XAxis,YAxis,Tooltip,Area,LineChart,Line,Legend,CartesianGrid,BarChart,Bar} from "recharts"
...
const Row1 = (_props: Props) => {
    ...
    const revenueExpenses = useMemo(() => {
      if (!data || !data || !data.monthlyData) return []; 
